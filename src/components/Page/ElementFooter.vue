  ...
  <div>
    <footer class=sction-footer>
      <section class="section z-1">
        ...
        <div class="text-line footer-list">
          <a href="tel:+74722732392" class="paragraph-small text-centered">
            &laquo;Славный сыровар&nbsp;&mdash; ремесленные сыры
            2020&raquo;&nbsp;| +7 (4722) 73-23-92
          </a>
          <a href="https://vk.com/slavnyi_syrovar" class="header-link-icon">
            <svg
              version="1.1"
              xmlns="http://www.w3.org/2000/svg"
              xmlns:xlink="http://www.w3.org/1999/xlink"
              viewBox="0 0 49.963 49.963"
              xml:space="preserve"
              width="50px"
            >
              <path
                id="vk"
                d="M40.593,26.138c-0.1-0.3,0.3-0.3,1.2-1.3c0.9-0.9,3.9-4.7,6.2-7.6c2.3-2.9,2-4.8,1.9-6.5c-0.1-1.8-1.1-2.6-2.1-3
         ...
         S22.593,11.138,22.493,11.238z"
          ...
          <a
            ...
            class="paragraph-small text-centered"
          >
            Группа компаний &laquo;Зеленая Долина&raquo;&nbsp;|
            www.zelenaya-dolina.com
          </a>
        </div>
      </section>
    </footer>
