<template>
  <div>
    <footer class="sction-footer">
      <section class="section z-1 sction-footer-bg">
        ...
        <div class="container bottom">
          <div class="centered catalog-element-footer">
            <div class="column-centered">
              ...
              >
                <img
                  ...
                  src="/allImage/logo/logo.png"
                />
              </a>
              <a
                href="tel:+74722732392"
                class="paragraph-small text-centered bold"
              >
                &laquo;Славный сыровар<br />
            ...
            <div class="column-centered">
              ...
              >
                Группа компаний <br />&laquo;Зеленая Долина&raquo;
                <br />www.zelenaya-dolina.com
              </a>
            </div>
          </div>
        </div>
